...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    response += "🤪 <b>Чепуха - Игра в команде</b>\n"
    response += "Русскоязычный многопользовательский Telegram бот для игры в 'Чепуху' — весёлую партийную игру, где 2-6 игроков последовательно отвечают на стандартные вопросы без видимости ответов друг друга, создавая забавные истории.\n\n"
