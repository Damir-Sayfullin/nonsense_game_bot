...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "Весёлая игра для групп, где вы пишете слова и получается смешная история.",
...
1️⃣ Игроки по очереди отвечают на вопросы
2️⃣ Вопросы: "Какой?", "Кто?", "С кем?", "Где?", "Что делали?", "Что с ними стало?"
3️⃣ Во время игры никто не видит ответов других игроков
4️⃣ В конце составляется история для каждого игрока
5️⃣ Получается столько историй, сколько игроков
