...
Вам будут заданы 6 вопросов:
1️⃣ Какой?
2️⃣ Кто?
3️⃣ С кем?
4️⃣ Где?
5️⃣ Что делали?
6️⃣ Что с ними стало?

Каждый отвечает <b>в личном чате</b> с ботом
• Никто не видит ответы других 🤐
• На каждый ответ — 5 минут ⏱️
• Если не ответишь — выпадешь из игры
...
• Каждый видит свою версию истории 😄

<b>🔄 ЭТАП 5: Новая игра</b>
В той же комнате можно сразу играть ещё раз!
Админ нажимает "▶️ Начать новую игру"
