...
• Если кто-то не ответит вовремя — игра полностью заканчивается и комната удаляется
• Нужно будет создать новую комнату и начать заново
...
После окончания игры комната удаляется
Создатель может нажать "🎮 Новая игра" и начать с новым кодом
